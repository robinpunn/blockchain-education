async function main() {
  ...
  const MayhemToken = await hre.ethers.getContractFactory("MayhemToken");

  const nft = await MayhemToken.deploy();
  ...
  await nft.safeMint(
    ...
    "ipfs://Qme51ob7U4kGqLP7WhztMCs8mFpmQeXqotvxkGVTVRUCKC"
  );
