...
contract MyGovernorTest is Test {
    ...
    uint256 public constant VOTING_DELAY = 1; // blocks until vote is active
    uint256 public constant VOTING_PERIOD = 50400; // time period we'll use to speed through voting period
