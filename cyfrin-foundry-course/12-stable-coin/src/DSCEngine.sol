...
contract DSCEngine is ReentrancyGuard {
     ...
     * @notice The function burns the DSC and redeems the underlying collateral in one transaction
     */
        ...
        external
    {
        ...
        // redeem collateral already checks health factor so _revertIfHealthFactorIsBroken not needed
    }
    ...
    function burnDsc(uint256 amount) public moreThanZero(amount) {
        ...
        _revertIfHealthFactorIsBroken(msg.sender); // we don't really need the revert as burning should strengthen the health factor
    }
